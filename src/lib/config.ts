...
export const siteConfig = {
  ...
  theme: process.env.NEXT_PUBLIC_THEME || 'solid',
  bgStyle: (process.env.NEXT_PUBLIC_BG_STYLE || 'solid') as BgStyle,
  primaryColor: process.env.NEXT_PUBLIC_PRIMARY_COLOR || '#9b7968',
  cardStyle: (process.env.NEXT_PUBLIC_CARD_STYLE || 'square') as CardStyle,
